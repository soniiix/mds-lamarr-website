...
export default function StudyPrograms() {
    return (
        <section id="formations" className="w-full py-16">
            ...
            {/* Sous-titre */}
            <div className="max-w-[1289px] mx-auto mb-6">
            ...
            <div className="max-w-[1289px] mx-auto">
                <div className="flex gap-6 pb-6 pr-6 snap-x snap-mandatory scrollbar-hide overflow-l-hidden">

                    {/* Carte 1 — rose */}
                    <div className="flex flex-col gap-6 flex-shrink-0 snap-start w-[490px]">
                        <ProgramCard
                        ...
                        <button
                            type="button"
                            className="bg-primary-200 w-full rounded-full px-6 py-3 text-base font-medium text-ink transition hover:opacity-90 self-start cursor-pointer"
                        >
                    ...
                    {/* Carte 2 — violet (IA) */}
                    <div className="flex flex-col gap-6 flex-shrink-0 snap-start w-[500px]">
                        <ProgramCard
                            color="bg-ia-100"
                        ...
                        <button
                            type="button"
                            className="bg-ia-100 rounded-full w-full px-6 py-3 text-base font-medium text-ink transition hover:opacity-90 self-start cursor-pointer"
                        >
                            Découvrir ce programme
                        </button>
                    </div>
                    ...
                    <div className="flex flex-col gap-6 flex-shrink-0 snap-start w-[500px]">
                        ...
                        <button
                            type="button"
                            className="bg-tech-200 w-full rounded-full px-6 py-3 text-base font-medium text-ink transition hover:opacity-90 self-start cursor-pointer"
                        >
                            Découvrir ce programme
                        </button>
                    </div>
